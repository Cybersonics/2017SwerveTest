...
public class RobotMap {
    ...
    public static void init() {
        ...
        shooterFlyWheel.setPID(0.0300, 0.00016, 0.45);
        ...
        relay0 = new Relay(0, Direction.kForward);
        relay0.setSafetyEnabled(false);
        relay0.set(Value.kOn);
        relay1 = new Relay(1, Direction.kForward);
        relay1.setSafetyEnabled(false);
